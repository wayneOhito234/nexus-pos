...
contextBridge.exposeInMainWorld('nexusSales', {
  ...
  markSynced: (localSaleId, serverId) =>
    ipcRenderer.invoke('sales:mark-synced', localSaleId, serverId),
...
// ── Cash drawer ───────────────────────────────────────────────────────────────
//
// Options are optional -- the main process falls back to the share name and
// pin from terminal config, so callers can just do nexusDrawer.open().
